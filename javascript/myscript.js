...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Trọng Phương dz nhất mixue " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Biết dz rồi khen lắm thế:';
document.querySelector('.Description .modal-body').innerHTML = 'Bấm vào dòng chữ kia ';
